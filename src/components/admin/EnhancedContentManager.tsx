...
import { Plus, Trash2, Save, Eye, EyeOff, RefreshCw, AlertCircle } from "lucide-react";
...
function EnhancedContentSection({ title, children, onSave, preview }: ContentSectionProps) {
      ...
      <AnimatePresence>
        {msg && (
          ...
          >
            ...
            >
              {msg.kind === "err" && <AlertCircle className="h-4 w-4" />}
              {msg.text}
            </div>
          </motion.div>
        )}
