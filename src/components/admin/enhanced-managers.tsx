...
import { EnhancedEntityManager } from "./EnhancedEntityManager";
...
export function EnhancedProjectsManager() {
  return (
    <EnhancedEntityManager<Project, ProjectInput>
      title="Projetos"
...
// --- Certificados Enhanced ---
export function EnhancedCertificatesManager() {
  return (
    <EnhancedEntityManager<Certificate, CertificateInput>
      title="Certificados"
...
export function EnhancedTestimonialsManager() {
  return (
    <EnhancedEntityManager<Testimonial, TestimonialInput>
      title="Depoimentos"
...
// --- Trajetória Enhanced ---
export function EnhancedMilestonesManager() {
  return (
    <EnhancedEntityManager<Milestone, MilestoneInput>
      title="Trajetória"
...
export function EnhancedSkillsManager() {
  return (
    <EnhancedEntityManager<SkillGroup, SkillGroupInput>
      title="Skills"
...
// --- Serviços Enhanced ---
export function EnhancedServicesManager() {
  return (
    <EnhancedEntityManager<Service, ServiceInput>
      title="Serviços"
