...
export function TooltipIconCard({img, text, marg, posit, widt, rotate, hovx }) {
    return (
        <div className="relative group" >
            ...
            <div className={`absolute top-0 ${posit} ${widt} h-auto border border-bluePrimary rounded-lg opacity-0 group-hover:opacity-100 ${hovx} group-hover:translate-x-0 duration-200 ease-out p-1`} >
                <Image src={"/icons/icon-projetos/Polygon_text.svg"} width={20} height={20} alt="Polig" className={`absolute right-full ${rotate} top-2/4`} />
