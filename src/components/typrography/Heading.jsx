export function Heading({ 
    ...
    const sizes = {
        ...
        larger: "text-[4rem] tracking-[-0.375] font-light sm:text-[9rem] lg:text-[13.5rem]", 
        large: "text-[4rem] tracking-[-0.375rem] font-light sm:text-[7rem] md:text-[10rem]", 
        midlle: "text-[3.5rem] tracking-[-0.375rem] font-light sm:text-[5rem] md:text-[7.5rem]", 
        menu: "text-[3rem] font-normal sm:text-[4.5rem] md:text-[5.25rem]", 
